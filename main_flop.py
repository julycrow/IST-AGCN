...
class Processor():
    ...
    def __init__(self, arg):
        ...
        if arg.phase == 'train':
            if not arg.train_feeder_args['debug']:
                ...
                if os.path.isdir(os.path.join(arg.work_dir, arg.model_saved_name)):
                ...
                self.train_writer = self.val_writer = SummaryWriter(os.path.join(arg.work_dir, arg.model_saved_name, 'test'), 'test')
        self.global_step = 0
        self.load_model()
        self.load_optimizer()
        self.load_data()
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (data, label, index) in enumerate(process):
            ...
            self.train_writer.add_scalar('acc', acc, self.global_step)  # 画曲线
